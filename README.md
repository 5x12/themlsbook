...
This repository is **a supplement** to the [**'Machine Learning For Everyone' book**](ml4everyone.com) by Andrew Wolf - an A-Z guide to the world of Data Science. This supplement contains the implementation of algorithms, statistical methods and techniques (in Python) that were described in the book.
